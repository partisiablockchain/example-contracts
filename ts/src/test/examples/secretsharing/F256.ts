...
export class F256 implements FiniteFieldElement<F256> {
   ...
   * The zero element.
   */
  static readonly ZERO: F256 = F256.createElement(0);

  /**
   * The one element.
   */
  static readonly ONE: F256 = F256.createElement(1);

  /**
   * Create a new field element with the given value.
   * @param value the value
   */
  static createElement(value: number): F256 {
    return new F256(value & 0xff);
  }

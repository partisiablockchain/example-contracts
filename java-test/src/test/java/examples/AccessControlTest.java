...
public final class AccessControlTest extends JunitContractTest {
  public static final ContractBytes CONTRACT_BYTES =
      ContractBytes.fromPaths(
          Path.of("../target/wasm32-unknown-unknown/release/access_control.wasm"),
          Path.of("../target/wasm32-unknown-unknown/release/access_control.abi"),
          Path.of("../target/wasm32-unknown-unknown/release/access_control_runner"));

...
public final class MultiVotingTest extends JunitContractTest {
  private static final ContractBytes MULTI_VOTING_CONTRACT_BYTES =
      ContractBytes.fromPaths(
          Path.of("../target/wasm32-unknown-unknown/release/multi_voting_contract.wasm"),
          Path.of("../target/wasm32-unknown-unknown/release/multi_voting_contract.abi"),
          Path.of("../target/wasm32-unknown-unknown/release/multi_voting_contract_runner"));

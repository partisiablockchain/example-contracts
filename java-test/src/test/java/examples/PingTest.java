...
public final class PingTest extends JunitContractTest {
  ...
  private static final ContractBytes CONTRACT_BYTES =
      ContractBytes.fromPaths(
          Path.of("../target/wasm32-unknown-unknown/release/ping_contract.wasm"),
          Path.of("../target/wasm32-unknown-unknown/release/ping_contract.abi"),
          Path.of("../target/wasm32-unknown-unknown/release/ping_contract_runner"));

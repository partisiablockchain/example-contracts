...
public final class MiaGameTest extends JunitContractTest {
  ...
  private static final ContractBytes MIA_CONTRACT =
      ContractBytes.fromPaths(
          Path.of("../target/wasm32-unknown-unknown/release/mia_game.zkwa"),
          Path.of("../target/wasm32-unknown-unknown/release/mia_game.abi"),
          Path.of("../target/wasm32-unknown-unknown/release/mia_game_runner"));

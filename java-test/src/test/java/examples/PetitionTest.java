...
public final class PetitionTest extends JunitContractTest {
  ...
  private static final ContractBytes CONTRACT_BYTES =
      ContractBytes.fromPaths(
          Path.of("../target/wasm32-unknown-unknown/release/petition.wasm"),
          Path.of("../target/wasm32-unknown-unknown/release/petition.abi"),
          Path.of("../target/wasm32-unknown-unknown/release/petition_runner"));

...
public final class NicknameTest extends JunitContractTest {
  public static final ContractBytes CONTRACT_BYTES =
      ContractBytes.fromPaths(
          Path.of("../target/wasm32-unknown-unknown/release/nickname.wasm"),
          Path.of("../target/wasm32-unknown-unknown/release/nickname.abi"),
          Path.of("../target/wasm32-unknown-unknown/release/nickname_runner"));

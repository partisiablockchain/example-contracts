...
fn add_data(
    ...
    let input_def = ZkInputDef::with_metadata(None, PublicInfoForEntry {});
...
fn compute_statistics(
    ...
    (
        state,
        vec![],
        vec![zk_compute::compute_statistics::start(
...
fn open_result_variable(
    ...
    let result = read_result(&zk_state, opened_variables.first());
